...
public class BrechBohne extends Card {
    private final ImageIcon image;

    public BrechBohne() {
        super("BrechBohne", createCoinMap());
        image = new ImageIcon("C:/Users/alyar/Desktop/bohnanza-demo-gui/bohnanza-gui/src/main/resources/BRECH_BOHNE.jpg"); // Replace with actual path
    }
