...
public class Sojabohne extends Card {
    private final ImageIcon image;

    public Sojabohne() {
        super("Sojabohne", createCoinMap());
        image = new ImageIcon("C:/Users/alyar/Desktop/bohnanza-demo-gui/bohnanza-gui/src/main/resources/SOJA_BOHNE.jpg"); // Replace with actual path
    }
